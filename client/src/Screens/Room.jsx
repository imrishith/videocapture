...
const RoomPage = () => {
  ...
  return (
    <Container fluid className="vh-100 d-flex flex-column justify-content-center align-items-center bg-dark text-white">
      <Card className="p-4 bg-secondary text-white w-100" style={{ maxWidth: "900px" }}>
        <h2 className="text-center mb-3">Room Page</h2>
        ...
        <Row className="mb-3 text-center">
          <Col>
            ...
            <Button variant="secondary" onClick={toggleAudio} className="me-2">
              {isAudio ? <FaMicrophone /> : <FaMicrophoneSlash />} 
            </Button>
            <Button variant="secondary" onClick={toggleVideo} className="me-2">
        ...
        <Row>
          <Col className="text-center">
            {myStream && (
              <>
                <h5>My Stream</h5>
                <ReactPlayer playing  height="300px" width="100%" url={myStream} className="border rounded" />
              </>
            )}
          </Col>
          <Col className="text-center">
            {remoteStream && (
              <>
                <h5>Remote Stream</h5>
                <ReactPlayer playing height="300px" width="100%" url={remoteStream} className="border rounded" />
              </>
            )}
          </Col>
